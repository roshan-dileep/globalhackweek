class SkyblockMemberStats {
    ...
    constructor(data) {
        ...
        Object.keys(data?.candy_collected || {}).forEach((year) => {
        ...
        this.auctions = {
            ...
            bought: {
                ...
                total: data?.auctions?.total_bought?.uncommon ||
            ...
            sold: {
                ...
                total: data?.auctions?.total_sold?.uncommon ||
...
//# sourceMappingURL=SkyblockMemberStats.js.map