...
function parse(data) {
    ...
    data
        .sort((a, b) => {
        if ((a.split('_')[0] || 'Unknown') < (b.split('_')[0] || 'Unknown'))
            return -1;
        if ((a.split('_')[0] || 'Unknown') > (b.split('_')[0] || 'Unknown'))
            return 1;
        return 0;
        ...
        if (undefined === minionData[minionName])
            minionData[minionName] = [];
...
//# sourceMappingURL=SkyblockMemberMinions.js.map