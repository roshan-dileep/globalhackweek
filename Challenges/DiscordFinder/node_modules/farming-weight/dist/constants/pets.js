...
export var FarmingPets;
(function (FarmingPets) {
    FarmingPets["Elephant"] = "ELEPHANT";
    FarmingPets["MooshroomCow"] = "MOOSHROOM_COW";
    FarmingPets["Bee"] = "BEE";
    FarmingPets["Rabbit"] = "RABBIT";
    FarmingPets["Slug"] = "SLUG";
    FarmingPets["TRex"] = "TYRANNOSAURUS";
})(FarmingPets || (FarmingPets = {}));
export var FarmingPetStatType;
(function (FarmingPetStatType) {
    FarmingPetStatType["Base"] = "base";
    FarmingPetStatType["Ability"] = "ability";
})(FarmingPetStatType || (FarmingPetStatType = {}));
export const FARMING_PETS = {
...
export const FARMING_PET_ITEMS = {
    YELLOW_BANDANA: {
        name: 'Yellow Bandana',
