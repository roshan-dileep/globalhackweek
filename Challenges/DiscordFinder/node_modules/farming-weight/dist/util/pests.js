import { FORTUNE_PER_PEST_BRACKET, KILLS_PER_PEST_BRACKET, PEST_COLLECTION_ADJUSTMENTS, PEST_COLLECTION_BRACKETS, PEST_EXCHANGE_RATES, PEST_IDS, PEST_TO_CROP, } from '../constants/pests.js';
export function fortuneFromPests(pests) {
    return PEST_EXCHANGE_RATES[pests] ?? 0;
}
export function unlockedPestBestiaryTiers(bestiaryKills) {
...
export function fortuneFromPestBestiary(bestiaryKills) {
    return unlockedPestBestiaryTiers(bestiaryKills) * FORTUNE_PER_PEST_BRACKET;
}
export function uncountedCropsFromPests(pestKills) {
    const crops = {};
